...
<html>
    ...
    <body>
        ...
        %>
                ...
                <div class="container">
                    <label style="margin-left: 10px">Dashboard</label>
                    <p style="margin-left: 10px">Maritime education field that user can find the information through specific subject.</p>
                    <div class="grid-container">
                        <div class="grid-item" style="background-color: #ff6666"><span class="icon"><i class="fas fa-ship"></i></span><br><span class="title"> Port and Shipping</span> </div>
                        <div class="grid-item" style="background-color: #66ccff"><span class="icon"><i class="fas fa-microchip"></i></span><br><span class="title"> Technology Maritime</span></div>
                        <div class="grid-item" style="background-color: #99ff66"><span class="icon"><i class="fas fa-anchor"></i></span><br><span class="title"> Shipping</span></div>
                        <div class="grid-item" style="background-color: #660033"><span class="icon"><i class="fas fa-truck-moving"></i></span><br><span class="title"> Port Management</span></div>
                        <div class="grid-item" style="background-color: #ff3300"><span class="icon"><i class="fas fa-compass"></i></span><br><span class="title"> Navigation</span></div>
                        <div class="grid-item" style="background-color: #e60000"><span class="icon"><i class="fab fa-old-republic"></i></span><br><span class="title"> Maritime Policies</span></div>                    
                    </div>
        <%
            List<File> allFile = studentDao.retrieveAllFile();
        %>
        ...
        %>
            <tr>
                <td><%= allFile.get(i).getFile_id()%></td>
                <td><%= allFile.get(i).getFile_name()%></td>
                <td><%= allFile.get(i).getFile_type()%></td>
                <td style="text-align: center"><a href="process-download file.jsp?id=<%= allFile.get(i).getFile_id()%>"><span class="icon"><i class="fas fa-copy"></i></span></a><a href="process-add-library.jsp?id=<%= allFile.get(i).getFile_id() %>"><span class="icon"><i style="color:yellow" class="fas fa-star"></i></span></a></td>
